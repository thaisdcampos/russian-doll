...
ActiveRecord::Schema.define(version: 20180523163026) do
  ...
  create_table "puzzle_hints", force: :cascade do |t|
    t.bigint "puzzle_id", null: false
    t.string "text"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["puzzle_id"], name: "index_puzzle_hints_on_puzzle_id"
  end
  ...
  add_foreign_key "puzzle_hints", "puzzles"
